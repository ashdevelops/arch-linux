sudo pacman -Syu base base-devel xorg-server xorg-xinit i3-wm ntfs-3g git nano rofi polybar dunst blueman bluez bluez-utils kitty nautilus firefox neofetch htop discord flameshot gnome-keyring nitrogen ranger dotnet-runtime dotnet-sdk sddm libpulse pipewire pipewire-pulse --noconfirm
