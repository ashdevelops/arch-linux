...
yay -Syu jetbrains-toolbox php composer spotify betterlockscreen plex-media-server visual-studio-code-bin zsh vlc waybar-git --nocleanmenu --nodiffmenu --noconfirm
