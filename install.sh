sudo pacman -Syu base base-devel xorg-server xorg-xinit i3-wm ntfs-3g git nano rofi polybar dunst blueman bluez bluez-utils kitty nautilus firefox neofetch htop discord --noconfirm
# non-essential: sddm nitrogen picom dotnet-runtime dotnet-sdk ranger pulse-mixer libpulse flameshot gnome-keyring
